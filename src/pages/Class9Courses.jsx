...
const Class9Courses = () => {
  ...
  const courses9 = [
    ...
    },
    {
      ...
      duration: "1 year",
      syllabus:
        "Full Maths + Science syllabus for Class 9 with weekly tests and assignments.",
      image_url:
            ...
            {courses9.map((course, index) => (
              ...
              >
                ...
                <div className="course-detail-image">
                  ...
                  <div className="course-class-badge">Class 9</div>
